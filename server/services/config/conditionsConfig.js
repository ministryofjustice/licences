  ...
  getAdditionalConditionsConfig: (use2019Conditions) =>
    [
      ...
      },
      {
        ...
        text: 'Do not contact anyone in prison or custody unless it’s approved by your probation officer first. This includes:<ul class="disc"><li>contact through social media</li><li>asking someone else to contact them for you</li><li>leaving a message for them to find</li></ul>',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'People, contact and relationships',
      ...
      {
        id: 'DO_NOT_MEET',
        text: 'Do not have contact or meet with [anyone associated (now or in the past) with] [name / specific group or organisation] unless it’s approved by your probation officer.',
      ...
      },
      {
        ...
        text: 'Do not have any contact with a known sex offender unless it’s approved by your probation officer.<br /><br />This does not apply when you attend a treatment programme or in your approved address to people living there.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'People, contact and relationships',
      ...
      },
      {
        ...
        text: 'Do not live or stay (even for one night) in the same place as [any child under / any female child under / any male child under / any vulnerable adult / any male vulnerable adult / any female vulnerable adult] unless it’s approved by your probation officer.',
      ...
      },
      {
        ...
        text: 'Do not have unsupervised contact with [any child under / any female child under / any male child under / any vulnerable adult / any male vulnerable adult / any female vulnerable adult] unless it’s approved by your probation officer [and/or social services department name].<br /><br />(This does not apply where the contact is not on purpose and could not be reasonably avoided during daily life).',
      ...
      },
      {
        ...
        text: 'Do not take part in any work or activity (paid or unpaid) which involves [any child under  / any female child under  / any male child under  / any vulnerable adult / any male vulnerable adult / any female vulnerable adult] unless it’s approved by your probation officer.',
      ...
      },
      {
        ...
        text: 'Do not approach or communicate with [name of victim and/or family members] unless it’s approved by your probation officer [and/or social services department].',
      ...
      },
      {
        ...
        text: 'Follow all instructions your probation officer gives you as part of your rehabilitation for [alcohol abuse / sexual behaviour / violent behaviour / gambling / solvent abuse / anger / debt / prolific behaviour / offending behaviour].',
      ...
      },
      {
        ...
        text: 'Give a [ORAL FLUID/URINE] sample to test you for specific drugs at the place your probation officer tells you to.<br /><br />Do not do anything to affect the drug testing process.',
      ...
      },
      {
        ...
        text: 'Go to all appointments arranged with  [a mental health worker / a medical practitioner / a leaving care social worker / children’s services].',
      ...
      {
        id: 'ALLOW_VISIT',
        text: 'Allow [a mental health worker / a medical practitioner / a leaving care social worker / children’s services] to visit you at your home.',
      ...
      {
        id: 'STAY_AT_ADDRESS',
        text: 'Stay at [address] between [time] and [time] every day unless your probation officer tells you not to.<br /><br />Follow instructions your probation officer gives you so they know where you are.<br /><br />Your probation officer will review this condition every [week / month] and decide if it’s safe to change or remove it.',
      ...
      // TODO clare to look at this one
      {
        ...
        text: 'Report to staff at [location] at [time and day] unless your probation officer tells you not to.<br /><br />Your probation officer will review this condition every [week / month] and decide if it’s safe to change or remove it.',
      ...
      },
      {
        ...
        text: 'Report to your probation officer within 2 working days if you return to the UK and islands before the end of your licence period. Your licence conditions will still apply.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Curfew, reporting and escorts',
      ...
      },
      {
        ...
        text: 'Tell your probation officer:<ul class="disc"><li>full details of any [passport / driving licence / birth certificate] you own</li><li>if you apply for a new [passport / driving licence / birth certificate]</li></ul>',
      ...
      },
      {
        ...
        text: 'Give your passport(s) to your probation officer and tell them if you are planning to apply for a new passport.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Travel and transportation',
      ...
      },
      {
        ...
        text: 'Tell your probation officer details of any vehicle you own, use regularly, or hire before you travel in them. This does not apply to public transport or private hire taxis.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Travel and transportation',
      ...
      {
        id: 'DO_NOT_TRAVEL_IN',
        text: 'Do not travel in or on any privately-owned vehicle that you own or owned by someone else unless it’s approved by your probation officer. This does not apply to public transport or private hire taxis.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Travel and transportation',
      ...
      },
      {
        ...
        text: 'Tell your probation officer full details of any reusable card you own or use on public transport, for example an Oyster card.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Travel and transportation',
      ...
      {
        id: 'DO_NOT_GO_AREA',
        text: 'Do not go in the specified area shown on the attached map unless it’s approved by your probation officer.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Exclusion',
      ...
      },
      {
        ...
        text: 'You will be subject to trail monitoring. Your electronic tag will monitor you everywhere you go. You must follow all instructions from your probation officer.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Technology',
      ...
      {
        id: 'GO_FOR_POLYGRAPH',
        text: 'Go for polygraph testing when your probation officer tells you to.<br /><br />Follow all instructions given by the person carrying out the polygraph testing.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Technology',
      ...
      },
      {
        ...
        text: 'Do not have more than one mobile phone or SIM card unless it’s approved by your probation officer.<br /><br />Provide your probation officer with details of your mobile phone and SIM card.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Technology',
      ...
      },
      {
        ...
        text: 'Get permission from your probation officer to buy, download, or use any software that:<ul class="disc"><li>encrypts information</li><li>deletes information</li><li>cleans your files or drives</li></ul>',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Technology',
      ...
      },
      {
        ...
        text: 'Do not [access / download / access or download] [specified websites or apps / types of websites or apps] unless it’s approved by your probation officer.',
      ...
      },
      {
        ...
        text: 'Provide your probation officer with the full addresses of all premises and storage facilities you have access to. This includes business premises.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Possession, ownership and finances',
      ...
      },
      {
        ...
        text: 'Do not have more than [amount] of cash (in any currency) unless it’s approved by your probation officer.',
      ...
      },
      {
        ...
        text: 'Provide your probation officer with details of any bank accounts and credit cards you have access to.<br /><br />Tell your probation officer details about any new bank accounts or credit cards you get access to.<br /><br />Your probation officer will review this condition every month and decide if it’s safe to change or remove it.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Possession, ownership and finances',
      ...
      },
      {
        ...
        text: 'Provide your probation officer with details of any third party bank account (or similar) you have access to or control of.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Possession, ownership and finances',
      ...
      },
      {
        ...
        text: 'Provide details to your probation officer of any money transfers to or from the UK which you send or receive.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Possession, ownership and finances',
      ...
      },
      {
        ...
        text: 'Do not go to or organise any meetings or gatherings except for worship unless it’s approved by your probation officer.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Extremism',
      ...
      },
      {
        ...
        text: 'Do not give any lecture, talk, or sermon (including acts of worship) unless it’s approved by your probation officer.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Extremism',
      ...
      },
      {
        ...
        text: 'Do not discuss or promote the grooming or influencing of an individual or group for extremism or radicalisation.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Extremism',
      ...
      },
      {
        ...
        text: 'Do not organise or contribute to any demonstration, meeting, gathering or website unless it’s approved by your probation officer.<br /><br />Your probation officer will review this condition every month and decide if it’s safe to change or remove it.',
        user_input: null,
        active: use2019Conditions,
        field_position: null,
        group_name: 'Extremism',
