...
const sectionContaining = {
    ...
    standard: 'licenceConditions', additional: 'licenceConditions', bespoke: 'licenceConditions',
    seriousOffence: 'finalChecks', onRemand: 'finalChecks', confiscationOrder: 'finalChecks',
    release: 'approval',
