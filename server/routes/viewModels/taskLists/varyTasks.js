...
module.exports = ({version, versionDetails, approvedVersion, approvedVersionDetails}) => ({stage}) => {
    ...
    const isNewVersion = versionInfo({version, versionDetails, approvedVersionDetails}).isNewVersion;

    return [
        {
            title: 'View current licence',
            label: `Licence version ${approvedVersion}`,
            action: {type: 'btn', text: 'View', href: `/hdc/pdf/create/${approvedVersionDetails.template}/`, newTab: true},
