...
module.exports = function(
    ...
    router.get('/select/:bookingId', checkLicence, asyncMiddleware(async (req, res) => {
    ...
    router.get('/taskList/:templateName/:bookingId', checkLicence, asyncMiddleware(async (req, res) => {
    ...
    router.get('/missing/:section/:templateName/:bookingId', checkLicence, asyncMiddleware(async (req, res) => {
    ...
    router.get('/create/:templateName/:bookingId', checkLicence, asyncMiddleware(async (req, res) => {
