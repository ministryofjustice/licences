...
export function buildAppInsightsClient(
  ...
  if (process.env.APPLICATIONINSIGHTS_CONNECTION_STRING) {
    ...
    defaultClient.addTelemetryProcessor(addUserDataToRequestsProcessor)
...
export function addUserDataToRequestsProcessor(envelope: EnvelopeTelemetry, contextObjects: ContextObject) {
