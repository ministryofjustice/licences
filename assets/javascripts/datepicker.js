...
!(function(e, t) {
    ...
    function t(e, t) {
        ...
        if (
            (['startDate', 'dateSelected', 'minDate', 'maxDate'].forEach(function(t) {
                if (e[t]) {
                    if (!f(e[t]) || isNaN(+e[t]))
                        throw new TypeError('"options.' + t + '" needs to be a valid JavaScript Date object.')
                    e[t] = p(e[t])
                }
            }),
            (e.startDate = e.startDate || e.dateSelected || p(new Date())),
            (e.formatter = 'function' == typeof i ? i : null),
            r < a)
        )
        ...
        return (
            ['onSelect', 'onShow', 'onHide', 'onMonthChange'].forEach(function(t) {
    ...
    function n() {
        return { startDate: p(new Date()), position: 'bl' }
    }
    function o(e) {
        var t = {}
    ...
    function s(e, t) {
        ...
        for (var y = 1; y <= v; y++) {
            ...
            ;+S != +r || g || (w += ' qs-active'),
                p.push('<div class="qs-square qs-num ' + m + ' ' + w + '">' + b + '</div>')
        }
        var x = c
            .map(function(e) {
    ...
    function i(e) {
        return (
            '\n      <div class="qs-overlay qs-hidden">\n        <div class="qs-close">&#10005;</div>\n        <input type="number" class="qs-overlay-year" placeholder="' +
            e.overlayPlaceholder +
            '" />\n        <div class="qs-submit qs-disabled">' +
            e.overlayButton +
            '</div>\n      </div>\n    '
        )
    }
    function c(e, t) {
        var n = t.currentMonth,
            ...
            c = e.textContent
        ;(t.dateSelected = new Date(o, n, c)),
            i && i.classList.remove('qs-active'),
            e.classList.add('qs-active'),
            l(a, t),
            y(t),
            s && s(t)
    }
    function l(e, t) {
        if (!t.nonInput)
            return t.formatter ? t.formatter(e, t.dateSelected) : void (e.value = t.dateSelected.toDateString())
    }
    function u(e, t, n) {
        n
            ? (t.currentYear = n)
            ...
            r(new Date(t.currentYear, t.currentMonth, 1), t),
            (t.currentMonthName = t.months[t.currentMonth]),
            t.onMonthChange && n && t.onMonthChange(t)
    }
    function d(e) {
        if (!e.noPosition) {
            var t = e.el,
                ...
                d =
                    '\n      top:' +
                    (u - (a ? l.height : -1 * c.height)) +
                    'px;\n      left:' +
                    (c.left - i.left + (s ? c.width - l.width : 0)) +
                    'px;\n    '
    ...
    function h(e) {
        ...
        ;(e = p(e)),
            ...
            (this.currentMonthName = this.months[e.getMonth()]),
            (this.dateSelected = e),
            l(this.el, this),
            r(e, this)
    }
    ...
    function v() {
        ...
        b.forEach(function(e) {
            ...
            e.remove(),
            e.hasOwnProperty('parentStyle') && (t.style.position = ''),
