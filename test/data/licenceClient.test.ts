...
describe('licenceClient', () => {
  ...
  describe('getApprovedLicenceVersion', () => {
    ...
    test('should pass in the correct sql', async () => {
      const expectedSelect =
        'select version, vary_version, template, timestamp, migration_state from v_licence_versions_excluding_deleted'
  ...
  describe('getLicencesInStageWithAddressOrCasLocation', () => {
    test('should pass in the correct parameters', async () => {
      const expectedParameters = ['stage']

      await licenceClient.getLicencesInStageWithAddressOrCasLocation('stage')
