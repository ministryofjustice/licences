...
describe('signInSAervice', () => {
    describe('signIn', () => {
        ...
        it('should getRO client credentials token when user role is RO', async () => {
            ...
            expect(fakeStore.addOrUpdate).to.be.calledTwice();
            expect(fakeStore.addOrUpdate).to.be.calledWith('un', 'type token', 'refresh');
            expect(fakeStore.addOrUpdate).to.be.calledWith('un', 'type token_2', 'refresh');
        });
    ...
    describe('refresh', () => {
        ...
        it('should get and store new token using refresh token when not RO', async () => {
            ...
            await service.refresh('CA', 'un', 'refresh');
        ...
        it('should get and store new token using client credentials when RO', async () => {
            ...
            await service.refresh('RO', 'un', 'refresh');
        ...
        it('should throw if there is a non 400 error with authentication', () => {
            ...
            return expect(service.refresh('CA', 'un', 'refresh')).to.eventually.be.rejected();
        });
    });
});
