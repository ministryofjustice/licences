    ...
    describe('NO_UNSUPERVISED_CONTACT', () => {
      ...
      test('should do nothing with last two inputs if social service dept !== yes', () => {
        ...
        expect(
          ...
          {
            text: '.<br /><br />(This does not apply where the contact is not on purpose and could not be reasonably avoided during daily life).',
          },
          {
            variable: undefined,
          },
      ...
      test('should combine last two variables if dept === yes', () => {
        const rawLicence = {
          licenceConditions: {
            additional: {
              NO_UNSUPERVISED_CONTACT: {
      ...
      test('should incorporate errors', () => {
        const rawLicence = {
          licenceConditions: {
            additional: {
              NO_UNSUPERVISED_CONTACT: {
