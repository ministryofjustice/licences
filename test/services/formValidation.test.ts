        ...
        const options = [
          ...
          },
          {
            ...
            outcome: {
              ...
              tuesdayFrom: 'Enter a valid time the curfew should start from',
              tuesdayUntil: 'Enter a valid time the curfew should run until',
              wednesdayFrom: 'Enter a valid time the curfew should start from',
              wednesdayUntil: 'Enter a valid time the curfew should run until',
              thursdayFrom: 'Enter a valid time the curfew should start from',
              thursdayUntil: 'Enter a valid time the curfew should run until',
              fridayFrom: 'Enter a valid time the curfew should start from',
              fridayUntil: 'Enter a valid time the curfew should run until',
              saturdayFrom: 'Enter a valid time the curfew should start from',
              saturdayUntil: 'Enter a valid time the curfew should run until',
              sundayFrom: 'Enter a valid time the curfew should start from',
              sundayUntil: 'Enter a valid time the curfew should run until',
            },
          },
        ]
