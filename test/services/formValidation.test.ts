        ...
        const options = [
          ...
          },
          {
            ...
            outcome: {
              ...
              tuesdayFrom: 'Enter a valid time the curfew should start from on Tuesday',
              tuesdayUntil: 'Enter a valid time the curfew should run until on Tuesday',
              wednesdayFrom: 'Enter a valid time the curfew should start from on Wednesday',
              wednesdayUntil: 'Enter a valid time the curfew should run until on Wednesday',
              thursdayFrom: 'Enter a valid time the curfew should start from on Thursday',
              thursdayUntil: 'Enter a valid time the curfew should run until on Thursday',
              fridayFrom: 'Enter a valid time the curfew should start from on Friday',
              fridayUntil: 'Enter a valid time the curfew should run until on Friday',
              saturdayFrom: 'Enter a valid time the curfew should start from on Saturday',
              saturdayUntil: 'Enter a valid time the curfew should run until on Saturday',
              sundayFrom: 'Enter a valid time the curfew should start from on Sunday',
              sundayUntil: 'Enter a valid time the curfew should run until on Sunday',
            },
          },
        ]
