        ...
        describe('Filtering', () => {
            ...
            describe('By stage', () => {
                context('user is CA', () => {
                    it('should not filter any statuses out', () => {
                        ...
                        return expect(
                            service.getHdcCaseList(user.token, user.username, 'CA', 'active')
                ...
                context('user is RO', () => {
                    it('should filter any statuses out', () => {
                        ...
                        return expect(
                            service.getHdcCaseList(user.token, user.username, 'RO', 'active')
                        ).to.eventually.eql([
                            { stage: 'PROCESSING_RO' },
                            { stage: 'PROCESSING_CA' },
                            { stage: 'APPROVAL' },
                ...
                context('user is DM', () => {
                    it('should filter any statuses out', () => {
                        ...
                        return expect(
                            service.getHdcCaseList(user.token, user.username, 'DM', 'active')
                        ).to.eventually.eql([
                            { stage: 'APPROVAL' },
                            { stage: 'DECIDED' },
                            { stage: 'PROCESSING_CA', status: 'Postponed' },
            ...
            describe('by status', () => {
                ...
                it('should remove active statuses when tab is inactive', () => {
                    ...
                    return expect(
                        service.getHdcCaseList(user.token, user.username, 'CA', 'inactive')
                    ).to.eventually.eql([
                        { stage: 'ELIGIBILITY', status: 'Excluded (Ineligible)' },
                        { stage: 'ELIGIBILITY', status: 'Not enough time - rejected' },
                        { stage: 'ELIGIBILITY', status: 'Presumed unsuitable' },
