...
describe('licenceService', () => {
    ...
    describe('updateAddresses', () => {
        ...
        it('should add form items to correct address', async () => {
            ...
            const output = await service.updateAddresses({
                licence: baseLicence,
                userInput: {addresses: [{postCode: 'pc3', addressIndex: 1}, {postCode: 'pc1', addressIndex: 0}]},
                fieldMap: [{postCode: {}, line1: {}}],
                nomisId: 1
            });
        ...
        it('should update both if necessary', async () => {

            const output = await service.updateAddresses({
                licence: baseLicence,
                userInput: {addresses: [{postCode: 'pc3', addressIndex: 0}, {postCode: 'pc4', addressIndex: 1}]},
                fieldMap: [{postCode: {}}],
                nomisId: 1
            });
            ...
            const expectedOutput = {
                proposedAddress: {
                    curfewAddress: {
                        addresses: [
                            {postCode: 'pc3', line1: 'a'},
                            {postCode: 'pc4', line1: 'b'}
                        ]
                    }
                }
            };
