...
describe('formatForView', () => {
    describe('dates', () => {
        ...
        it('should format nested dates', () => {
            ...
            expect(formatObjectForViewWithOptions(object, { dates: ['a', 'f'], capitalise: ['o'] })).to.eql(
                expectedOutput
            )
        })
    ...
    describe('names', () => {
        it('should format names to be capitalised', () => {
            ...
            expect(formatObjectForViewWithOptions(object, { dates: ['a', 'd'], capitalise: ['b'] })).to.eql(
                expectedOutput
            )
        })
        ...
        it('should format nested names to be capitalised', () => {
            ...
            expect(formatObjectForViewWithOptions(object, { dates: ['a', 'd'], capitalise: ['o'] })).to.eql(
                expectedOutput
            )
        })
    })
