...
describe('userService', () => {
    ...
    describe('updateRoUser', () => {
        ...
        it('should call user client with params', async () => {
            ...
            await service.updateRoUser('nomisId', 'deliusId', 'first', 'last');

            expect(userClient.updateRoUser).to.be.calledOnce();
            expect(userClient.updateRoUser).to.be.calledWith('nomisId', 'deliusId', 'first', 'last');
        });
    });
    ...
    describe('addRoUser', () => {
        ...
        it('should reject when nomisId already exists', async () => {
