        ...
        context('additional condition task not started', () => {
            it('should display a start button for additional conditions task', () => {
                return request(app)
                    ...
                    .expect('Content-Type', /html/)
                    .expect(res => {
                        expect(res.text).to.include('/hdc/licenceConditions/standardConditions/noms">Start');
                    });
        ...
        context('additional condition task started', () => {
            it('should display a view button for curfew address', () => {
                ...
                return request(app)
                    ...
                    .expect('Content-Type', /html/)
                    .expect(res => {
                        expect(res.text).to.include('/hdc/licenceConditions/standardConditions/noms">View');
                    });
